package com.danielks.api2.data.remote

import com.danielks.api2.data.service.StudentService
import retrofit2.Retrofit
import retrofit2.converter.gson.GsonConverterFactory

object RetrofitClient {
    // URL base da API (todas as requisições partem daqui)
    private const val BASE_URL = "api-capgemini.onrender.com/"
    ...
    val api: StudentService by lazy {
        ...
        Retrofit.Builder()
            ...
            // Cria a implementação da interface StudentService
